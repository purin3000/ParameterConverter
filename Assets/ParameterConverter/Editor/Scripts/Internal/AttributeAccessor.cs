...
namespace ParameterConverter.Editor.Internal {
  public static class AttributeAccessor {
    ...
    private class CustomMethodUtil {
      ...
      private CallbackFunctionAttribute GetCustomMethod(MethodInfo method) {
        return (CallbackFunctionAttribute)Attribute.GetCustomAttribute(method, typeof(CallbackFunctionAttribute));
      }
    }
    ...
    private class CustomClassUtil {
      ...
      private ConvertTargetAttribute GetCustomClass(Type type) {
        return (ConvertTargetAttribute)Attribute.GetCustomAttribute(type, typeof(ConvertTargetAttribute));
      }
    }
  }
}